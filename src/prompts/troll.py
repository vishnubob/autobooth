...
steps = [
    Step(
        ...
        assistant_message=AssistantMessage(message="Ahoy, adventurous duo! Envision yourselves as archaeologists, delicately unearthing a priceless ancient artifact from the depths of a perilous tomb. Signal with a 'ready' when you've struck the pose.")
    ),
    Step(
        title="Misleading Pose Direction and Await 'Ready'",
        user_message=UserMessage(message="ready", people_count=2),
        assistant_message=AssistantMessage(
            message="Astounding work, you daring explorers of the sandbox! Who would've thought your historic find would be amidst a children’s playdate? Up for another delightful twist?",
